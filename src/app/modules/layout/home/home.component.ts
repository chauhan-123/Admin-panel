...
export class HomeComponent extends Pagination implements OnInit {
  ...
  get createdOn(): FormGroup {
    return this.filterForm.get('createdOn') as FormGroup;
  }
  ...
  constructor(private homeService: HomeService,
    ...
    this.filterForm = fb.group({
      createdOn: fb.group({
        from: [data && data.createdOn && data.createdOn.from || null],
        to: [data && data.createdOn && data.createdOn.to || null]
      }),
